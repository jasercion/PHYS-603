...
Let's stop here for a moment and look at the above expression.  We know that $\ln{1\mp\ebk}\cong\mpe^{\beta\mu}e^{-\beta E_{k}}$ in the limit $-\mu>>T$  This means that in this limit we can approximate the first term, $\pm\bltz T gV\int\dtk\ln{1\mp\ebk}$, as $TN$.  In our classical case this is much less than the value of the second term $\mu N$.  
